...
define( 'MWPSFE_VERSION',        (string) ( $mwpsfe_plugin_data['Version'] ?? '1.3.0' ) );
...
require_once MWPSFE_PLUGIN_DIR . 'includes/class-mwpsfe-public-operation-contract.php';
...
require_once MWPSFE_PLUGIN_DIR . 'includes/class-mwpsfe-integration-context-service.php';
require_once MWPSFE_PLUGIN_DIR . 'includes/class-mwpsfe-public-api.php';
